...
export default function ReportChat({ visible, onClose, chatId, reportedUserId, reportedUserName, reportedUserProfileImage }) {
  ...
  // Updated reasons contextualized for reporting an interactive user chat
  const reasons = [
    "Harassment or Bullying",
    "Spam or Scam Attempt",
    "Inappropriate Media Shared",
    "Hate Speech or Verbal Abuse",
    "Others",
  ];
  ...
  // Logic Preserved: Submit Handling for Chat Logs
  const handleSubmit = async () => {
    ...
    try {
      const reportData = {
        ...
        reportedUserProfileImage: reportedUserProfileImage || null,
      ...
      // Saves specifically into a Reports_Chats Firestore collection
      await addDoc(collection(db, 'Reports_Chats'), reportData);
      ...
      setLoading(false);
      console.log('Chat report submission failed:', err);
      showSileo({
        title: 'Error',
        ...
        <View style={styles.overlay}>
          <View style={styles.modalContainer}>
            ...
            <View style={styles.headerRow}>
              <Text style={styles.modalTitle}>Report Chat</Text>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
              <Text style={styles.subTitle}>Help us understand what is wrong with the conversation with <Text style={styles.boldText}>{reportedUserName}</Text></Text>
              ...
              <TextInput
                placeholder="Briefly describe the safety or behavior issue..."
              ...
              <TouchableOpacity style={styles.uploadArea} onPress={pickImage}>
                {image ? (
                  ...
                  <View style={styles.uploadPlaceholder}>
                    ...
                    <Text style={styles.uploadPlaceholderText}>Upload Screenshot</Text>
                  </View>
                )}
              </TouchableOpacity>
            </ScrollView>
      ...
      <Modal visible={successModal} animationType="fade" transparent>
        <View style={styles.overlay}>
          <View style={styles.successCard}>
            ...
            <Text style={styles.successSub}>Thank you for reporting safety violations. Our moderation team will review this chat conversation shortly.</Text>
            <TouchableOpacity
